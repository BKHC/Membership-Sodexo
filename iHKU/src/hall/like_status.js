  ...
  componentDidMount() {
    ...
    _like = () => {
      ...
      if (newitem.like_status == "1"){
        ...
        fetch(`https://i.cs.hku.hk/~wyvying/php/hall/delete_like_status.php?commentID=${encodeURIComponent(parseInt(commentID))}&userID=${encodeURIComponent(parseInt(userID))}`, {
            method: "GET",
        });
        ...
        fetch(`https://i.cs.hku.hk/~wyvying/php/hall/change_like_status.php?like_status=${encodeURIComponent(1)}&commentID=${encodeURIComponent(parseInt(commentID))}&userID=${encodeURIComponent(parseInt(userID))}`, {
            method: "GET",
        });
      } else {
        newitem.like_status = "1";
        newitem.likes = parseInt(newitem.likes) + 1;
        fetch(`https://i.cs.hku.hk/~wyvying/php/hall/add_like_status.php?like_status=${encodeURIComponent(1)}&commentID=${encodeURIComponent(parseInt(commentID))}&userID=${encodeURIComponent(parseInt(userID))}`, {
            method: "GET",
        });
      }
    ...
    _dislike = () => {
      ...
      if (newitem.like_status == "1"){
        ...
        newitem.dislikes = parseInt(newitem.dislikes) + 1;
        newitem.likes = parseInt(newitem.likes) - 1;
        fetch(`https://i.cs.hku.hk/~wyvying/php/hall/change_like_status.php?like_status=${encodeURIComponent(0)}&commentID=${encodeURIComponent(parseInt(commentID))}&userID=${encodeURIComponent(parseInt(userID))}`, {
            method: "GET",
        });
      } else if (newitem.like_status == "0"){
        newitem.like_status = "-1";
        ...
        newitem.like_status = "0";
        newitem.dislikes = parseInt(newitem.dislikes) + 1;
        fetch(`https://i.cs.hku.hk/~wyvying/php/hall/add_like_status.php?like_status=${encodeURIComponent(0)}&commentID=${encodeURIComponent(parseInt(commentID))}&userID=${encodeURIComponent(parseInt(userID))}`, {
            method: "GET",
        });
      }
      this.setState({items: newitem});
