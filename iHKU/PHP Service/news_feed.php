...
session_start();
  ...
  $check_query = "SELECT * FROM `Hall Rate` ORDER BY '$search_hist' DESC";
  $result = mysqli_query($db, $check_query);
  ...
  while($row=mysqli_fetch_array($result))
    ...
    $check_query1 = "SELECT * FROM `Restaurant Rate` ORDER BY "$search_hist" DESC";
  $result1 = mysqli_query($db, $check_query1);
  ...
  while($row=mysqli_fetch_array($result1))
    ...
    $check_query2 = "SELECT * FROM `Course Rate` ORDER BY '$search_hist' DESC";
  $result2 = mysqli_query($db, $check_query2);
